...
\author[Demétrio C. G. B.]{Profa. Dra. Clarice Garcia Borges Demétrio}
...
\begin{frame}
  ...
  \end{enumerate}
  \vspace{0.5cm}
  O enfoque nesta etapa será dado no item \textbf{(i)}.
\end{frame}
...
\begin{frame}
  ...
  \small Devido a natureza da variável, considera-se o intervalo de
  variação dos dados (\textbf{amplitude}) de forma a dividí-los em
...
\begin{frame}
  ...
  \begin{block}{\bf Amplitude total ($A$)}
    Limite inferior: $X_{\mbox{mínimo}}$\\
    \vspace{.2cm}
    Limite superior: $X_{\mbox{máximo}}$\\
    \vspace{.2cm}
    Amplitude total: $A = X_{\mbox{máximo}} - X_{\mbox{mínimo}}$
  \end{block}
...
\begin{frame}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\hsize]{images/pontos1}
    \includegraphics[width=0.5\hsize]{images/pontos2}
    \caption{Gráficos de pontos.}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Polígono de frequência}
    ...
    respectivos pontos médios. Para se obter as interseções dos
...
\begin{frame}
  ...
  \begin{block}{Histograma}
    \begin{figure}[b]
      \includegraphics[width=8cm]{images/histaltura}
      \caption{Histograma para a variável altura.}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Histograma e polígono de frequências}
    \begin{figure}[b]
      \includegraphics[width=8cm]{images/histpolialtura}
      \caption{Histograma e polígono de frequência para a variável
        altura.}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Ogiva de Galton}
    ...
    os pontos de coordenadas $(LS_i; F_i)$ ou $(LS_i, F'_i)$, onde
    $LS_i$ é o limite superior da classe $i$.
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Ogiva}
    \begin{figure}[b]
      \includegraphics[width=8cm]{images/Ogiva}
      \caption{Ogiva para a variável altura.}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{lc}\hline
      Síndrome de & Número de \\
      regeneração & espécies \\ \hline
      Heliófitas & 4 \\
      Oportunistas de clareira & 11\\
      Tolerantes & 15 \\ \hline
      Total & 30 \\ \hline
    \end{tabular}
  \end{center}
