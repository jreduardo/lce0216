...
\begin{frame}{Distribuição binomial}
  ...
  \begin{enumerate}[(a)]
    \footnotesize
  \item A probabilidade de não aparecer plantas com mutação em um total
    de 1000 plantas irradiadas;
  ...
  \item A probabilidade de não aparecer planta com mutação em 2000
    plantas irradiadas;
  \item A probabilidade de aparecer pelo menos duas plantas com mutação
    em 2000 plantas irradiadas;
...
\begin{frame}{Distribuição de Poisson}
  ...
  probabilidade dele não conseguir realizar a simulação.
\end{frame}
